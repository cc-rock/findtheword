...
void main() {
  ...
  blocTest("When the checkbox is checked, the password field is enabled",
  ...
  blocTest("When continue is clicked and the create room request is successful, the loading state and success state are sent",
      build: () {
  ...
  blocTest("When continue is clicked (with password) and the create room request is successful, the loading state and success state are sent",
      build: () {
  ...
  blocTest("When continue is clicked and the create room request is unsuccessful, the loading state and error state are sent",
      build: () {
